...
import '../Home Page Display/detail_desc_page.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(arrData.mPlacesData[0]['Places_title'] , style: TextStyle(fontSize: 20),),
              mSizedBox(),
              SizedBox(
                height: 350, // Increased height to accommodate all content
                child: ListView.builder(
                    itemCount: arrData.mPlacesData[0]['Popular Places'].length,
              ...
              SizedBox(
                height: 350, // Increased height to accommodate all content
                child: ListView.builder(
                    itemCount: arrData.mPlacesData[1]['Popular Places'].length,
                    scrollDirection: Axis.horizontal,
                    itemBuilder: (context, index) {
                      final place =
              ...
              SizedBox(
                ...
                child: ListView.builder(
                    scrollDirection: Axis.horizontal,
                    itemCount: arrData.mPlacesData[2]['Popular Places'].length,
                    itemBuilder: (_ , index){
                      final place2 = arrData.mPlacesData[2]['Popular Places'][index];
                      return Padding(
